...
public class ConnectionUtil {
	...
	public static Connection getConnection() throws SQLException {
		...
		String url = "jdbc:postgresql://appian-210419.cvtq9j4axrge.us-east-1.rds.amazonaws.com:5432/demos";
...
//		/*
//		 * Finally blocks are so commonly used to close resources (open connections outside of Java) that
//		 * there is a short to creating a finally block that does that. It is a "try with resources block"
//		 * that declares the resource to open and then close at the try declaration. 
//		 */
